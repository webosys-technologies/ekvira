...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?staff=<?=$f_type?>&flag=non">Home</a> &raquo; Edit Teachers Details<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
if($id > 0)
{
	$query=sprintf("SELECT * FROM stu_faculty WHERE id='%d'", $id); 
...
?>
    ...
    <div class="main-wrapper">
        <!-- Start Here -->
		  ...
		  <form action="submit.php" method="POST"  name="regisfrm" onsubmit='return admin_ward();' class="form">		
           ...
           <div class="field">
				...
				<div class="fieldrt">
				  <input type="text" class="input-text" style="text-transform:uppercase;" value="<?php echo stripslashes($row_add['name']);?>" title="Faculty Name" id="name" name="name" onblur='notnull(this.id);' />
				</div>
			</div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" title="Date Of Birth" value="<?php echo dateformate(stripslashes($row_add['dob']));?>" id="dob" name="dob" onBlur='notnull(this.id);' />
				</div>
			</div>
            ...
            <div class="fieldrt">
             ...
             <li><input name="gender" type="radio" value="M" <?php if($row_add['gender']=='M'){?> checked="checked"<?php }?> id="male" required /><label for="male">Male</label></li>
              <li><input name="gender" type="radio" <?php if($row_add['gender']=='F'){?> checked="checked"<?php }?> value="F" id="female" style="margin-left:25%;" required /><label for="female">Female</label></li>
              </ul>
            </div>
        </div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" title="Designation" value="<?php echo stripslashes($row_add['designation']);?>" id="desig" name="desig" onBlur='notnull(this.id);' />
				</div>
			</div>
        ...
        <div class="field">
				...
				<div class="fieldrt">
                 ...
                 <?php
						...
						{
						?>
						<option value='<?php echo $row_edu['edu_id']?>' <?php if($row_edu['edu_id']==stripslashes($row_add['designation'])){?>selected="selected" <?php }?> ><?php echo stripslashes($row_edu['edu']);?></option>
						<?php
						}?>
                </select>
				</div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo stripslashes($row_add['address']);?>" title="Address" id="addr" name="addr" onBlur='notnull(this.id);' />
				</div>
			</div>
        ...
        <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo stripslashes($row_add['contact']);?>" title="Contact No." id="contact" name="contact" onBlur='notnull(this.id);' />
				</div>
			</div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo dateformate(stripslashes($row_add['doj']));?>" title="Date Of Joining" id="doj" name="doj" onBlur='notnull(this.id);' />
				</div>
			</div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo stripslashes($row_add['salary']);?>" title="Salary" id="sal" name="sal" onBlur='notnull(this.id);' />
				</div>
			</div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo stripslashes($row_add['experience']);?>" title="Experience Till Date" id="exp" name="exp" onBlur='notnull(this.id);' />
				</div>
			</div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo stripslashes($row_add['other']);?>" title="Other Details" id="other" name="other" onBlur='notnull(this.id);' />
				</div>
			</div> 
