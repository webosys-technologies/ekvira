...
$condition2=" ORDER BY d_id DESC";	

$que="SELECT * FROM stu_duration $condition2"; 
$pagesize=10;	
...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --> DurationManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <!-- Start Here -->
        <h2>Student duration Details</h2>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <?php
				$clcnt=0;
				while($row_d=$page_res->fetch_assoc())
				{ 
			  ...
			  <tr>
				...
				<td align='left'><?=stripslashes($row_d['duration'])?></td>
