...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo; Add Duration<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <!-- Start Here -->
			...
			<div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" title="Course Duration" id="name" name="name" placeholder="IN MONTHS" onBlur='notnull(this.id);' />
				</div>
			</div>
