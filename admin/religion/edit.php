...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo; Edit Religion<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
if($id > 0)
{
	$query=sprintf("SELECT * FROM stu_religion WHERE religion_id='%d'", $id); 
...
?>
    ...
    <div class="main-wrapper">
        <!-- Start Here -->
			...
			<h2><?php echo $title;?>  Religion Details</h2>
			
			<form action="submit.php" method="POST"  name="regisfrm" onsubmit='return admin_ward();' class="form">		
			<div class="field">
				<label><strong>Religion Name :<em>*</em></strong></label>
				<div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo stripslashes($row_add['religion']);?>" title="Religion Name" id="name" name="name" onBlur='notnull(this.id);' />
				</div>
			</div>
