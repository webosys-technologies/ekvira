...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo; Edit Caste<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
if($id > 0)
{
	$query=sprintf("SELECT * FROM stu_caste WHERE caste_id='%d'", $id); 
...
?>
    ...
    <div class="main-wrapper">
        <!-- Start Here -->
			...
			<h2><?php echo $title;?>  <strong>Caste</strong> Details</h2>
			
		  <form action="submit.php" method="POST"  name="regisfrm" onsubmit='return admin_ward();' class="form">		
			<div class="field">
				<label><strong>Caste Name :<em>*</em></strong></label>
		  <div class="fieldrt">
					<input type="text" class="input-text" value="<?php echo stripslashes($row_add['caste']);?>" title="Caste Name" id="name" name="name" onBlur='notnull(this.id);' />
				</div>
			</div>
