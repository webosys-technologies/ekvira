...
$condition2=" ORDER BY caste_id DESC";	

$que="SELECT * FROM stu_caste $condition2"; 
$pagesize=10;	
...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->CasteManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <?php
				$clcnt=0;
				while($row_caste=$page_res->fetch_assoc())
				{ 
					if($clcnt%2==0){$class="even";}else{$class="";}
					$clcnt++;
					$id=$row_caste['caste_id'];
					
			  ?>
			  <tr>
				<td  align="center"><?=$clcnt?>.</td>
				<td align='left'><?=stripslashes($row_caste['caste'])?></td>
				
				<td>
					
					<ul class="actions">
						<li><a title="edit" href="edit.php?flag=<?=$flag?>&txtmode=edit&id=<?=$id?>" ><img alt="edit" src="../../images/pencil.png"></a></li>
						<li><a href="submit.php?flag=<?=$flag?>&id=<?=$id?>&amp;txtmode=del" onClick="if(confirm('Do you really want to delete this Caste?')){return true;}else{return false;}"><img alt="delete" src="../../images/trash.png"></a></li>
					</ul>
