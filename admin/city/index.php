...
$condition2=" ORDER BY city_id DESC";	

$que="SELECT * FROM stu_city $condition2"; 
$pagesize=10;	
...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="../admin.php">Admin</a> &raquo; CityManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <tr>
				...
				<td align='left'><?=stripslashes($row_city['city'])?></td>
