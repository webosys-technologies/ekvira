...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo; Add City<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <!-- Start Here -->
			...
			<div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" title="City Name" id="name" name="name" onBlur='notnull(this.id);' />
				</div>
			</div>
