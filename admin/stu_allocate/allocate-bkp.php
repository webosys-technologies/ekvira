                  ...
                  <tbody class='ms'>
				   ...
				   $que_tab="SELECT * FROM ".$table_name." LIMIT 1";
					if(!($check_tab = $con->query($que_tab))){
						 ...
						 $query_create1=sprintf("CREATE TABLE IF NOT EXISTS ".$table_name1."(`id` int(11) NOT NULL AUTO_INCREMENT,`stud_id` int(11) NOT NULL,PRIMARY KEY (`id`), UNIQUE KEY `stud_id` (`stud_id`)) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1");	
