...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --> StockManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
  ...
  <tr>
    <td><div align="right"><a href="index.php?stock=study&amp;flag=non" class="button">Show Study Stock</a></div></td>
    <td><div align="right"><a href="index.php?stock=physical&flag=non" class="button">Show Physical Stock</a></div></td>
  </tr>
</table>
        ...
        <?php if(isset($_REQUEST['stock'])){ 
         ...
         ?>
         <h2>Student Study Item Stock Details</h2>
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <tr>
				...
				<td align='left'><?=stripslashes($row_store['item_name'])?></td>
				...
				<td>
					...
					<ul class="actions">
						<li><a title="edit" href="edit.php?flag=<?=$flag?>&txtmode=edit&stock=study&id=<?=$id?>" ><img alt="edit" src="../../images/pencil.png"></a></li>
						<li><a href="submit.php?flag=<?=$flag?>&id=<?=$id?>&txtmode=del&stock=study" onClick="if(confirm('Do you really want to delete this City?')){return true;}else{return false;}"><img alt="delete" src="../../images/trash.png"></a></li>
					</ul>				</td>
			  </tr>
			  <?php
				}?>
         ...
         <?php   	
				...
				$rowCount = $con->affected_rows;
		?>
        <h2>Student Physical Item Stock Details</h2>
        <div align="right"><a href="add.php?flag=<?=$flag?>&amp;stock=physical" class="button">Add New</a></div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  <thead>      
			  <tr>
				<th width='8%'>Sr. No.</th>
				<th width="18%" align='left'>Item Name</th>
				<th width="17%" align='left'>Quantity</th>
			  ...
			  <tr>
				...
				<td><?=stripslashes($row_store['brand'])?></td>
				<td><?=stripslashes($row_store['other'])?></td>
				<td>
					
					<ul class="actions">
						<li><a title="edit" href="edit.php?flag=<?=$flag?>&stock=physical&txtmode=edit&amp;id=<?=$id?>" ><img alt="edit" src="../../images/pencil.png"></a></li>
						<li><a href="submit.php?id=<?=$id?>&amp;txtmode=del&stock=physical" onClick="if(confirm('Do you really want to delete this City?')){return true;}else{return false;}"><img alt="delete" src="../../images/trash.png"></a></li>
					</ul>				</td>
			  </tr>
			  <?php
				}?>
