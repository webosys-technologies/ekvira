...
$condition2=" ORDER BY course_id DESC";	

$que="SELECT * FROM stu_course $condition2"; 
$pagesize=10;	
...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->CourseManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <!-- Start Here -->
        <h2>Student <strong>Course</strong> Details</h2>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <tr>
				...
				<th align='left'><strong>Course</strong> Name</th>
			  ...
			  <?php
				$clcnt=0;
				while($row_city=$page_res->fetch_assoc())
				{ 
					if($clcnt%2==0){$class="even";}else{$class="";}
					$clcnt++;
					$id=$row_city['course_id'];
					
			  ?>
			  <tr>
				<td  align="center"><?=$clcnt?>.</td>
				<td align='left'><?=stripslashes($row_city['course'])?></td>
				
				<td>
					
					<ul class="actions">
						<li><a title="edit" href="edit.php?flag=<?=$flag?>&txtmode=edit&amp;id=<?=$id?>" ><img alt="edit" src="../../images/pencil.png"></a></li>
						<li><a href="submit.php?flag=<?=$flag?>&id=<?=$id?>&amp;txtmode=del" onClick="if(confirm('Do you really want to delete this City?')){return true;}else{return false;}"><img alt="delete" src="../../images/trash.png"></a></li>
					</ul>
