...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo; Add Course<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <!-- Start Here -->
			...
			<h2>Add New <strong>Course</strong></h2>
		  ...
		  <div class="fieldrt">
					<input type="text" class="input-text" title="Religion Name" id="name" name="name" onBlur='notnull(this.id);' />
				</div>
			</div>
