...
$condition2=" ORDER BY edu_id DESC";	

$que="SELECT * FROM stu_edu $condition2"; 
$pagesize=10;	
...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->QualificationManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <!-- Start Here -->
        <h2>Student <strong>Qualification</strong> Details</h2>
				
		  <div align="right"><a href="add.php" class="button">Add New</a></div>
        
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  <thead>      
			  <tr>
				<th width='10%'>Sr. No.</th>
				<th align='left'><strong>Qualification</strong> Name</th>
			  ...
			  <?php
				$clcnt=0;
				while($row_edu=$page_res->fetch_assoc())
				{ 
			  ...
			  <tr>
				...
				<td align='left'><?=stripslashes($row_edu['edu'])?></td>
				
				<td>
					
					<ul class="actions">
						<li><a title="edit" href="edit.php?flag=<?=$flag?>&txtmode=edit&amp;id=<?=$id?>" ><img alt="edit" src="../../images/pencil.png"></a></li>
						<li><a href="submit.php?flag=<?=$flag?>&id=<?=$id?>&amp;txtmode=del" onClick="if(confirm('Do you really want to delete this Qualification?')){return true;}else{return false;}"><img alt="delete" src="../../images/trash.png"></a></li>
					</ul>
