...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo;  Add User<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <!-- Start Here -->
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<select class="slct" id="usertype" name="usertype"  required>
                          <option value=''>Please Select User Type</option>
                          <option value='SU'>Super User</option>
                          <option value='TU'>Teacher User</option>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="text" class="input-text" title="username" id="usrname" name="usrname" onBlur='notnull(this.id);' />
				</div>
			</div>
			...
			<div class="field">
				...
				<div class="fieldrt">
					<input type="password" class="input-text" title="Password" id="pswd" name="pswd" onBlur='notnull(this.id);' />
				</div>
			</div>
            ...
            <div class="field">
				...
				<div class="fieldrt">
					<input type="password" class="input-text" title="Re-Password" id="repswd" name="repswd" onBlur='notnull(this.id);' />
				</div>
			</div>
