...
$condition2=" ORDER BY sub_id DESC";	

$que="SELECT * FROM stu_subject $condition2"; 
$pagesize=10;	
...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->SubjectManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <?php
				$clcnt=0;
				while($row_sub=$page_res->fetch_assoc())
				{ 
			  ...
			  <tr>
				...
				<td align='left'><?=stripslashes($row_sub['subject'])?></td>
				...
				<td>
					...
					<ul class="actions">
						<li><a href="submit.php?flag=<?=$flag?>&id=<?=$id?>&amp;txtmode=del" onClick="if(confirm('Do you really want to delete this Subject?')){return true;}else{return false;}"><img alt="delete" src="../../images/trash.png"></a></li>
					</ul>				</td>
			  </tr>
			  <?php
				}?>
