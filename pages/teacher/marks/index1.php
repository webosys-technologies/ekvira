            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Contact No."></th>
                        
                        <th><input type="text" class="form-control" placeholder="Class"></th>
                        <th><input type="text" class="form-control" placeholder="Section"></th>
