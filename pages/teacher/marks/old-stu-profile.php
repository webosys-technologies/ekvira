...
$sql = "SELECT * from stu_prov_marksheet WHERE prov_id='$prov_id'";
...
<?php
           ...
           ?>
            ...
            <div class="container">
                <div class="row">
            <div class="panel panel-info">
                <div class="panel-heading"><h3 style="font-weight: bold;">DEVELOPMENT OF SUBJECT LEARNING SKILL</h3></div>
                <div>
                    <table class="tbl-qa">
                <thead>
                                ...
                                <tr class="table-head">
                                      ...
                                      <th class="table-header">PROV_ID</th>
                        ...
                        ?>
                                <tr class="table-row">
                                    <td class="td-color"><?php echo $k+1; ?></td>
                                      <td class="td-color" contenteditable="true" onBlur="saveToDatabase(this,'subjects','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["subjects"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'mt_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["mt_1"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'mt_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["mt_2"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'fa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["fa_1"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'fa_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["fa_2"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'wte_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["wte_1"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'sa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["sa_1"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'mt_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["mt_3"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'mt_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["mt_4"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'fa_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["fa_3"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'fa_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["fa_4"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'wte_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["wte_2"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'sa_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["sa_2"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'fa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["fa_1_2"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'fa_3_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["fa_3_4"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'sa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["sa_1_2"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'og','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["og"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'prov_id','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["prov_id"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'class','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["class"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'section','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["section"]; ?></td>
                                      <td contenteditable="true" onBlur="saveToDatabase(this,'date','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["date"]; ?></td>
                                </tr>
                      <?php
                      }
                      ?>
 ...
 <div class="container">
                ...
                <div col-xs-12 col-sm-6 col-md-6>
                                    ...
                                    <div>
                                        ...
                                        <div class="col-xs-12 col-sm-3"><a href="stu-result.php?prov_id=<?php echo $_GET['prov_id']; ?>" class="btn btn-info btn-block btn-md" style="color: white;">See Result</a></div>
                                </div>
                                    <div>

                                        <div class="col-xs-12 col-sm-3"><a href="stu-result.php?prov_id=<?php echo $_GET['prov_id']; ?>&pdf=true" class="btn btn-primary btn-block btn-md" style="color: white;">Confirm & Print</a></div>
                                </div>
                            </div>
...
<script>
		...
		function saveToDatabase(editableObj,column,id) {
			$(editableObj).css("background","#0079ac url(loaderIcon.gif) no-repeat right");
                        ...
                        if($.isNumeric(editableObj.innerHTML) && editableObj.innerHTML.length < 4){
                            $.ajax({
                            url: "saveedit.php",
                            type: "POST",
