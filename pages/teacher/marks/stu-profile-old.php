                             ...
                             foreach($data_marksheet as $k=>$v) {
                                ...
                                <tr class="table-row" id="table-row5">
                                    <td class="td-color"><?php echo $k+1; ?></td>
                                      ...
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["mt_1"])) echo "class='tdgcell'"; ?> onBlur="saveToDatabase(this,'mt_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["mt_1"]; ?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["mt_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'mt_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["mt_2"]; ?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $a = calculatemarks($data_marksheet[$k]["mt_1"],$data_marksheet[$k]["act_1"]); echo $data_marksheet[$k]["fa_1"] = $a;?></td>
                                      ...
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["sa_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $x = calculatesa($a,$b,$data_marksheet[$k]["wte_1"]); ?></td>
                                      ...
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_3"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $c = calculatemarks($data_marksheet[$k]["mt_3"],$data_marksheet[$k]["act_3"]); ?></td>
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $d = calculatemarks($data_marksheet[$k]["mt_4"],$data_marksheet[$k]["act_4"]); ?></td>
                                      ...
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["sa_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $y = calculatesa($c,$d,$data_marksheet[$k]["wte_2"]); ?></td>
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_1_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($a,$b); ?></td>
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_3_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_3_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($c,$d); ?></td>
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["sa_1_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($x,$y); ?></td>
                                      <td class="tdcell5" contenteditable="true" <?php if(!empty($data_marksheet[$k]["og"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'og','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["og"]; ?></td>
