...
<?php
           ...
           <!--First table-->
            ...
            <div class="panel panel-info">
                ...
                <div class="alert alert-danger" id="messa" style="display:none;margin-bottom:0px;" ><p><strong>Warning!!</strong>&nbspMarkesheet is already locked you can't edit.</p></div>
                <div class="alert alert-success" id="messa1" style="display:none;margin-bottom:0px;" ><p><strong>Success!!</strong>&nbspYou Marks Submitted Successfully & Locked</p></div>
                <div class="alert alert-danger" id="messa2" style="display:none;margin-bottom:0px;" ><p><strong>Warning!!</strong>&nbspMarkesheet is already locked by teacher & admin . So you can't edit.</p></div>
                <div>
...
$count = 0;
                                ...
                                function calculate($data_marksheet, $k, $val) {
                                        echo $data_marksheet[$k][$val];
                                        if (!empty($data_marksheet[$k][$val])) {
                                            return 1;
                                        }

                                        return 0;
                                    }
                                function calculate_without_print($data_marksheet, $k, $val) {
                                        if (!empty($data_marksheet[$k][$val])) {
                                            return 1;
                                        }
                                ...
                                function enable_table($data_marksheet,$k,$val,$count)
                                    { ?>
                                    ...
                                    <td class="td-color"><?php echo $k+1; ?></td>
                                      ...
                                      <td id="disab" contenteditable="true" <?php if(!empty($data_marksheet[$k]["mt_1"])) echo "class='tdgcell'"; ?> onBlur="saveToDatabase(this,'mt_1','<?php echo $data_marksheet[$k]["id"];  ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"mt_1");?></td>
                                      <td id="disab" contenteditable="true" <?php if(!empty($data_marksheet[$k]["mt_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'mt_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"mt_2");?></td>
                                      <td id="disab" class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $a = calculatemarks($data_marksheet[$k]["mt_1"],$data_marksheet[$k]["act_1"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_1");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $b = calculatemarks($data_marksheet[$k]["mt_2"],$data_marksheet[$k]["act_2"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_2"); ?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["wte_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'wte_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["wte_1"]; $count=$count+calculate($data_marksheet,$k,"wte_1");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["sa_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $x = calculatesa($a,$b,$data_marksheet[$k]["sa_1"]); $count=$count+calculate_without_print($data_marksheet,$k,"sa_1"); ?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["mt_3"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'mt_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"mt_3");?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["mt_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'mt_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"mt_4");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_3"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $c = calculatemarks($data_marksheet[$k]["mt_3"],$data_marksheet[$k]["act_3"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_3");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $d = calculatemarks($data_marksheet[$k]["mt_4"],$data_marksheet[$k]["act_4"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_4");?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["wte_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'wte_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"wte_2");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["sa_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $y = calculatesa($c,$d,$data_marksheet[$k]["wte_2"]); $count=$count+calculate_without_print($data_marksheet,$k,"sa_2");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_1_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($a,$b); $count=$count+calculate_without_print($data_marksheet,$k,"fa_1_2");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["fa_3_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_3_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($c,$d); $count=$count+calculate_without_print($data_marksheet,$k,"fa_3_4");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["sa_1_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($x,$y); $count=$count+calculate_without_print($data_marksheet,$k,"sa_1_2");?></td>
                                      <td class="tdcell1" contenteditable="true" <?php if(!empty($data_marksheet[$k]["og"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'og','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $data_marksheet[$k]["og"]; $count=$count+calculate_without_print($data_marksheet,$k,"og");?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["act_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"act_1");?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["act_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"act_2"); ?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["act_3"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"act_3");?></td>
                                      <td contenteditable="true" <?php if(!empty($data_marksheet[$k]["act_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"act_4"); ?></td>
                                </tr> 
                                    <?php 
                                return $count;
                                    }
                                    
                                    function disble_table($data_marksheet,$k,$val,$count)
                                    { ?>
                                        <tr class="table-row" id="table-row5">
                                    <td class="td-color"><?php echo $k+1; ?></td>
                                      ...
                                      <td class="tdcell2" id="disab" contenteditable="false" <?php if(!empty($data_marksheet[$k]["mt_1"])) echo "class='tdgcell'"; ?> onBlur="saveToDatabase(this,'mt_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"mt_1"); ?></td>
                                      <td class="tdcell2" id="disab" contenteditable="false" <?php if(!empty($data_marksheet[$k]["mt_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'mt_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"mt_2"); ?></td>
                                      <td class="tdcell2" id="disab" class="tdcell1" contenteditable="false" <?php if(!empty($data_marksheet[$k]["fa_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $a = calculatemarks($data_marksheet[$k]["mt_1"],$data_marksheet[$k]["act_1"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_1"); ?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["fa_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $b = calculatemarks($data_marksheet[$k]["mt_2"],$data_marksheet[$k]["act_2"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_2");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["wte_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'wte_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"wte_1"); ?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["sa_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $x = calculatesa($a,$b,$data_marksheet[$k]["wte_1"]); $count=$count+calculate_without_print($data_marksheet,$k,"sa_1");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["mt_3"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'mt_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"mt_3"); ?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["mt_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'mt_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"mt_4"); ?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["fa_3"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $c = calculatemarks($data_marksheet[$k]["mt_3"],$data_marksheet[$k]["act_3"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_3");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["fa_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $d = calculatemarks($data_marksheet[$k]["mt_4"],$data_marksheet[$k]["act_4"]); $count=$count+calculate_without_print($data_marksheet,$k,"fa_4");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["wte_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'wte_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"wte_2"); ?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["sa_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo $y = calculatesa($c,$d,$data_marksheet[$k]["wte_2"]); $count=$count+calculate_without_print($data_marksheet,$k,"sa_2");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["fa_1_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($a,$b); $count=$count+calculate_without_print($data_marksheet,$k,"fa_1_2");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["fa_3_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'fa_3_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($c,$d);  $count=$count+calculate_without_print($data_marksheet,$k,"fa_3_4");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["sa_1_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'sa_1_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php echo calculatefa($x,$y);  $count=$count+calculate_without_print($data_marksheet,$k,"sa_1_2"); ?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["og"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'og','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate_without_print($data_marksheet,$k,"og");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["act_1"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_1','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"act_1");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["act_2"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_2','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"act_2");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["act_3"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_3','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php  $count=$count+calculate($data_marksheet,$k,"act_3");?></td>
                                      <td class="tdcell2" contenteditable="false" <?php if(!empty($data_marksheet[$k]["act_4"])) echo "class='tdgcell'"; ?>  onBlur="saveToDatabase(this,'act_4','<?php echo $data_marksheet[$k]["id"]; ?>')" onClick="showEdit(this);"><?php $count=$count+calculate($data_marksheet,$k,"act_4");?></td>
...
//                                 die('1:TU 1:SU');
                                     ...
                                     foreach ($data_marksheet as $k => $v) {
                                         $count = disble_table($data_marksheet, $k, $val, $count);
                                         $all = 140;
                                         $total = ($count / $all) * 100;
                                         $width = $total;
                                         ?>
 ...
 else if($data[$k]["teacher_status"] == 1 && $usertype == 'TU') {
//                                 die('1:TU');
        foreach ($data_marksheet as $k => $v) {
            $count = disble_table($data_marksheet, $k, $val, $count);
            $all = 140;
...
//                                 die('GU/SU');
        foreach ($data_marksheet as $k => $v) {
            $count = enable_table($data_marksheet, $k, $v, $count);
            $all = 140;
            $total = ($count / $all) * 100;
            $width = $total;
        }
...
//                                 die('else');
    ...
    ?>
                   ...
                   <div class="container">
                       <?php 
$width1=$total;
                       $width= number_format((float)$width1, 2, '.', ''); 
 ?>
                        <h4 style="font-weight: bold; text-align: center; color: #0079ac;">Profile Completed </h4>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-10">
                           
                            <div class="progress" id="progress">
                                    <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $width; ?>%">
                                    <?php echo $width; ?>%
                                </div>
                            </div>
                        </div>
...
//                            echo $_SESSION['u_type']; die;
                            if($ts==1 && $tr=='TU' && $as==1 && $ar=='SU' && $_SESSION['u_type']==$current_login)
                                { ?>
                                  <script>
