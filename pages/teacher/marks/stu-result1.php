...
$allocated = sprintf("SELECT faculty_id FROM s_1_a WHERE stud_id='%d'", $prov_id);
       ...
       <div class="row" id="result">
        <div class="col-xs-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body" id="result_print" style="padding-bottom: 1px; padding-top:2px;">
        ...
        <h4 align="center"style="color:firebrick">WEBS-www.esob.co.in; CN-8550991135; 07228-222025; 
        </br>email: ekvira_school@rediffmail.com; chavhan_tushar@yahoo.com; helpdesk@esob.co.in <br />First Terminal Assisment Report</br>SESSION-2015-2016<br />CLASS:<? echo $data['course_id'].' ('.$data['section_id'].')'?></h4>
   ...
   <?php
    $print_data.='
        ...
        <div style="align:center font-size:20px">
          ...
          <h4 align="center" style="color:firebrick">EKVIRA SCHOOL OF BRILLIANTS MORSHI(MH) </h4>
        <h4 align="center"style="color:firebrick">WEBS-www.esob.co.in; CN-8550991135; 07228-222025; </br>
        email: ekvira_school@rediffmail.com; chavhan_tushar@yahoo.com; helpdesk@esob.co.in <br />
        First Terminal Assisment Report</br>SESSION-2015-2016<br />CLASS:'.$data['course_id'].' ('.$data['section_id'].')</h4>
