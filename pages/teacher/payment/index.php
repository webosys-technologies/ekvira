        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <tr  style="text-transform:uppercase;">
				...
				<td>
					...
					<ul class="actions">
						<li></li>
						<li><a href="pay.php?flag=<?=$flag?>&id=<?=$id?>&staff=<?=$staff_type?>&txtmode=inactive" onClick="if(confirm('Do you really want to pay salary?')){return true;}else{return false;}"><img alt="delete" src="../../../images/back.png"></a></li>
					</ul>				</td>
			  </tr>
			  <?php
				}?>
