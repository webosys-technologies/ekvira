...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo; Select Date<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
if($id > 0)
{
    ...
    <p align="center">&nbsp;</p>
    <form  method="post" action="home.php?flag=<?=$flag?>">
        ...
        <table width="100%" class="tbl" border="0">
          ...
          <tr style="font-size:14px;">
            ...
            <td><input name="a_date" type="text" id="a_date" class="input-text" required="required" placeholder="Click to select Date" /> </td>
            <td><p class="button"><input type="submit" class="button" value="Click to Fill Attendance" /></p>              </td>
            <td>&nbsp;</td>
            </tr>
        </table>
