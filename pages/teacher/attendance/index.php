...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->StudentAttendanceManagement<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <?php
		 ...
		 if($user_type=='SU'){
			...
			$que="SELECT * FROM stu_t_subject WHERE status=1 $condition2";
		 	...
		 	$condition2=" ORDER BY id ASC";	
			$que="SELECT * FROM stu_t_subject WHERE user_id=".$user_id." and status=1 $condition2";
		 }
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl">
			  ...
			  <tr>
				...
				<th width='10%'>Show History</th>
				<th width='10%'>Fill Attendance</th>
			    </tr>
			  </thead>
			  <tbody class='ms'>
			  <?php
			  ...
			  <tr  style="text-transform:uppercase;">
				...
				<td><ul class="actions">
                    <li><a href="view_attend.php?flag=non&amp;id=<?=$id?>"><img src="../../../images/search.png" alt="Attendance" /></a></li>
                </ul></td>
				<td>
					
					<ul class="actions">
						<li><a href="selectdate.php?flag=non&amp;id=<?=$id?>"><img src="../../../images/confirm.png" alt="Attendance" /></a></li>
				</ul>				</td>
			    </tr>
			  <?php
				}?>
