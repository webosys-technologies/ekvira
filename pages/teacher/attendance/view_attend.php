...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->View Attendance  Details<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
         ...
         <div class="add_button">
   	    ...
   	    <tr>
   	      <td width="63%">&nbsp;</td>
                ...
                <p align="right"><a href="export/export.php?id=<?=$id?>&tname=<?=$tname?>" class="button">Export To Excel Sheet</a></p></td>  
        </tr>
        </table> 
       </div>
  ...
  while ($fieldinfo=mysqli_fetch_field($result))
    {
	 $colname=$fieldinfo->name;
		if($colname=='id'){
			...
			echo "<th>".datefromcol($colname)."</th>";
		}
    }
	echo "</tr></thead>";
	$cnt=0;
