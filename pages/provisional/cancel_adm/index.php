...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->Povisional Student List<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
  ...
  <script type="text/javascript">
		   var xmlHttp = createXmlHttpRequestObject();
			...
			function process(id){
					var id = id;
					var reason = prompt("Please enter Reason for Cancelling Admission");
					if(reason!=''){
					 location.href="cancel.php?reason=" +reason+ "&id=" +id;
					}
			}
 </script>
        
      <p align="right"><a href="list.php?flag=<?=$flag?>" class="button">View Cancel List</a></p>
       <?php
	  // require '../common/connect.php';
	   ...
	   ?>
        <font color="#FF0000"><div id="msgview" align="center"></div></font>
        ...
        <table width="100%" border="0" class="tbl">
         <thead>
          <tr>
            ...
            <th width="4%">Caste</th>
            <th width="23%">Correspondent Address</th>
          ...
          <tr>
            ...
            <td>
            	<ul class="actions">
                <li><a onClick="if(confirm('Do you really want to Cancel this student Admission?')){ process(<?=$id?>); return true;}else{return false;}"><img src="../../../images/delete.png" alt="CANCEL" width="30" height="28"></a></li>
				<!--		<li><a href="cancel.php?id=<?=$id?>" onClick="if(confirm('Do you really want to Cancel this student Admission?')){return true;}else{return false;}"><img src="../../../images/delete.png" alt="CANCEL" width="30" height="28"></a></li> -->
				</ul>           
		...
		<? } ?>	
		<? if($flag=="cancel"){?>
		<p align="center"><font color='red'><B>Admission of is cancelled Successfully.</B></font></p>
		<? } ?>	
        </div>
        <!-- InstanceEndEditable -->
      </div>
