...
<!--   <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
          <form action="bonafide.php" method="GET" class="form">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h4 class="modal-title">Reason of Bonafide</h4>
                        </div>
                        <div class="modal-body">
                          <textarea class="form-control" name="infoa" id="infoa" style="min-width: 100%" required></textarea>
                        </div>
                        <div class="modal-footer">
                            <input name="id" type="hidden" id="id" value="<?php echo $id; ?>" class="button"/>
                            <input name="input" type="submit" id="submit" value="Submit" class="button"/>
                        </div>
                  </form>       
      </div>
        ...
        <div class="main-wrapper">
            <div style="border-style: double;background-color: #FEF9E7;">
                    ...
                    <div class="logo-result1">
                        <h1><u>BONAFIDE / DOMICILE CERTIFICATE</u></h1>
                    </div>
                    <div class="logo-result1">
                        <p>This is certify that <b><?=$fullname?> </b>son/daughter of <?=$row_prov['mname']?>&nbsp;<?=$row_prov['lname']?> residing at 43,Dipawali Society, Near Mahalaxmi<br> Char Rasta,Paladi,Latur is bonafide student for the reasons of.<br>
                                He/she bears a moral character.His/Her Date of Birth is <?=$dob?> and place ob birth is <?=$city?>.</p>
                    </div>
                    <div style="margin-top:40px;">
                        <div><h3 style="float: left;margin-left:100px;padding-bottom: 20px;"><em><b>Place:</b></em>&nbsp;<em><?=$city?></em></h3>
                            <h3 style="margin-left:700px;padding-bottom: 20px;"><b><em>Principal</em></b></h3></div>
