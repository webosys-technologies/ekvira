...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a>  &raquo;Admit Student<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
$(document).ready(function()
{
    ...
    $(function(){
      $('#duedate').daterangepicker({
        ...
        <form action="preview.php?flag=non" method="post" class="form">
        ...
        <div class="field">
            ...
            <div class="fieldrt">
                <input type="text" class="input-text" value="" title="Contact" id="contact" name="contact" required />
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="fieldrt">
                <input type="text" class="input-text" value="" title="Full Address" id="c_address" name="c_address" />
       		 </div>
        </div>
            ...
            <div class="fieldrt">
                ...
                <select name="section_id" id="section" class="slct" required >
                  <option selected="selected" value="">Please Select Section</option>
						...
						{
						?>
                        <option value="<?php echo $row_section['section']; ?>"><?php echo $row_section['section']; ?></option> 
				  <?php } ?>
...
<!--         <div class="field">
         ...
         <div class="field">
            ...
            <div class="fieldrt">
                <input type="text" class="input-text" value="" title="Fees Due-Date" id="duedate" name="duedate" required />
       		 </div>
        </div>
