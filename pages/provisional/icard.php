        ...
        <div class="main-wrapper">
            <div class="main">
                    <div class="main-sub">
                        ...
                        <div class="logo-result2">
                            <img src="../../images/only-logo1.png" alt="Logo" />
                        </div>
                        <div class="logo-result1">    
                            <h1 style="color:#fff"><em>Ekvira School Of Brilliants Group</em></h1><h3 class="sub-head">WEBS-www.esob.co.in;email:helpdesk@esob.co.in;<br>Tel:91-8550991135,91-07228-222025</h3>
                        </div>
                        </div>
                    </div>
                   
                 <div class="logo-result3">
                        <h1 style="color:#BD5959;">I-CARD</h1>
                    </div>
                
                <table style=" width:54%;float: left;margin-top: 15px;">
                    <tr>
            ...
            <div class="print_button" style="width:15%;margin:0 auto;"><a href="#" class="button" onclick="window.print();">Print & PDF</a></div>
