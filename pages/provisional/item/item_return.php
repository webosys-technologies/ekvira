...
<div class="wrapper">
   ...
   <form action="submit.php" method="post">
        ...
        <table width="80%" height="324" border="1" class="tbl" align="center">
          <tr>
            <td height="51"><strong>Student Name :-- </strong></td>
            <td height="51" colspan="2"><?=$fullname?></td>
          </tr>
          <tr>
            <td width="23%"><strong>Study Stock Items :-</strong></td>
    ...
    <p>
      <input id="select_all" type="checkbox" onClick="toggle_study(this)" />
		  ...
		  $condition2=" ORDER BY id DESC";	
 			...
 			?>
                <tr>
                  <td><input name="items_study[]" type="checkbox" value="<?=$row_store['id']?>" /></td>
                  <td><div align="center">
                      <?=$row_store['item_name']?>
                  </div></td>
                  <td><div align="center">
            ...
            <?php if($nothaving!=1){ ?>
              ...
              <font color="#FF0000"><b>NO Study Items Are Allocated</B></font>
              <?php		
			  		  }  
                ?>            </td>
          </tr>
          <tr>
            ...
            <td height="94" colspan="2"><table width="90%" border="0" class="tbl" align="center">
                <thead>
                  <tr>
                    <th width="5%"> <p> All </p>
                        <p>
		  ...
		  $condition2=" ORDER BY id DESC";	
				...
				{ 
					...
					$query_study = sprintf("SELECT * FROM stu_prov_item WHERE prov_id='%d' and stock_id=2 and item_id='%d' and return_date IS NULL", $id, $item_id);
					if (!($result_study = $con->query($query_study))) 
					{ echo "FOR QUERY: $query_study<BR>".$con->error; 	exit;}
					$rowCount1 = $con->affected_rows;
					if(	$rowCount1>0)
 			...
 			?>
                  <tr>
                    <td><input name="items_phy[]" type="checkbox" value="<?=$row_store['id']?>" /></td>
                    <td><div align="center">
                        <?=$row_store['item_name']?>
                    </div></td>
                    <td><div align="center">
              ...
              <font color="#FF0000"><b>No Physical Training Items Are Allocated</b></font>
              <?php		
			  		  }  
                ?>            </td>
          </tr>
