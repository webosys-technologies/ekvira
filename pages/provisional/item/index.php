...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->Item Allocation Details<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
       ...
       <div class="flag-msg">
		...
		<? if($flag=="add"){?>
		<p align="center"><font color='red'><B>Items Allocated successfully.</B></font></p>
		<? } ?>	
		<? if($flag=="return"){?>
		<p align="center"><font color='red'><B>Items Returned Successfully.</B></font></p>
		<? } ?>	
        <? if($flag=="back"){?>
		<p align="center"><font color='red'><B>No Items Allocated or Returned.</B></font></p>
		<? } ?>	
        </div>
        ...
        <table width="100%" border="0" class="tbl">
          <thead>
            <tr>
              ...
              <th width="5%">M/F</th>
              <th width="19%">Study Item List</th>
              <th width="19%">Physical Item List</th>
              <th width="7%">View Details</th>
              <th width="8%">Allocate Item</th>
              <th width="7%">Return Item</th>
              </tr>
          </thead>
          <tbody class='ms'>
          <?php
            ...
            <tr>
			  ...
			  ?> </td>
              <td><ul class="actions">
                  <li><a href="view.php?id=<?=$id?>&amp;flag=non"><img src="../../../images/search.png" alt="Allocate Item" /></a></li>
</ul></td>
              <td><ul class="actions">
                  <li><a href="item_allocate.php?id=<?=$id?>&mode=old&flag=non"><img src="../../../images/confirm.png" alt="Allocate Item" /></a></li>
</ul></td>
              <td><ul class="actions">
                  <li><a href="item_return.php?id=<?=$id?>&mode=old&flag=non"><img src="../../../images/edit.png" alt="Allocate Item" /></a></li>
              </ul></td>
              </tr>
            <?php } ?>
          </tbody>
