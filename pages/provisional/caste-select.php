...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo;   ProvisionalAdmission<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
    ...
    <div class="fullbox">
        ...
        <div align="center">
          ...
          <caption align="top">
            <strong>SELECT CAST CATEGORY</strong>
            </caption>
          ...
          <tr>
           <td colspan="2" align="center">
             <input class="button" name="submit" value="SUBMIT" type="submit" />           </td>
           </tr>
         </form>
        </table>
        </div>                
