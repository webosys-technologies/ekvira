...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" -->Export_Book_Details<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
       ...
       <div class="add_button">
   	    ...
   	    <tr>
   	      <td width="37%">&nbsp;</td>
           	  ...
           	  <td width="28%" align="right"><p align="right"><a href="exporthis.php?flag=his" class="button">Export History Sheet</a></p></td>  
        </tr>
        </table> 
       </div>
        ...
        <table width="100%" border="0" class="tbl">
          <thead>
            <tr>
              ...
              <th width="7%">M/F</th>
              <th width="32%"><strong>Book</strong> List</th>
              </tr>
          </thead>
          <tbody class='ms'>
          <?php
