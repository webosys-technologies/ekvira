        ...
        <div class="main-wrapper">
            <div style="border-style: double;background-color: #F0FFFF;">
                    ...
                    <div class="logo-result1">
                        <h1><u>CHARACTER CERTIFICATE</u></h1>
                    </div>
                    <div class="logo-result1">
                        <p>This is certify that <b><?=$fullname?> </b>son/daughter of <?=$row_prov['mname']?>&nbsp;<?=$row_prov['lname']?> was the student of during of the year from to his/hir Character and conduct were during his/her stay in this School.</p>
                    </div>
                    <div style="width:100%; margin-bottom:50px; text-align: center;">
                        <div style="float:left;width:33%;"><h3><em><b>Place:</b></em>&nbsp;<?=$city?></h3></div>
                        <div style="float:left;width:33%;"><h3><b><em>Head Master</em></b></h3></div>
                        <div style="float:right;width:33%;"><h3><b><em>Principal</em></b></h3></div>
                    </div>
