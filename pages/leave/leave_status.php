...
<div class="wrapper">
	...
	<div class="box">
        ...
        <div class="boxinner">
        	<p>You are here &raquo; <strong><!-- InstanceBeginEditable name="here" --><a href="index.php?flag=non">Home</a> &raquo; StudentLeaveStatus<!-- InstanceEndEditable --></strong></p>
      </div>
    </div>
...
if($id > 0)
{
	...
	if (!($page_res = $con->query($que))){ echo "FOR QUERY: $que<BR>".$con->error; 	exit;}
       ...
       <p align="right" class="back-to-index"><a href="index.php?flag=non" class="button">Back To Index</a></p>
        ...
        <!-- Start Here -->
       	  <p align="center" class="style2">STUDENT LEAVE STATUS</p>
          ...
          <table width="100%" border="0" class="tbl">
            <thead>
              <tr>
                ...
                <th width="19%">OPENING DATE/TIME </th>
                <th width="19%">CLOSING DATE/TIME</th>
                <th width="7%"><p>NO. OF </p>
                  <p>Approved days</p>                </th>
                <th width="50%">REASON</th>
